...
def train_phase(num_epochs, phase_name):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            patience_counter = 0
            torch.save(farseg.state_dict(), f"models/best_model_{phase_name}_africa.pth")
        else:
            patience_counter += 1
...
# save model
torch.save(get_model(farseg).state_dict(), "models/farseg_model_africa.pth")
